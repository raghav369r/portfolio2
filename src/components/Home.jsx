  ...
  return (
    <div className="relative flex flex-col md:flex-row h-[100vh] ">
      <div className="h-[350px]  flex flex-col justify-between w-full md:w-1/3 bg-primary md:h-full">
        <h1 className="text-black font-semibold text-2xl md:text-5xl text-left md:text-center p-4 font-mixed">
          RaGhav
        </h1>
      ...
      <div className="flex flex-col relative w-full md:w-2/3 bg-neutral-800 h-full items-center justify-center">
        <div>
          <img
            className="size-[200px] -top-[100px] right-1/2 translate-x-1/2 md:translate-x-0 block object-fill z-10 absolute md:top-[calc(50vh-150px)] md:-left-[150px] md:size-[300px] rounded-full bg-neutral-500"
            src="/images/profile.jpeg"
            alt=""
          />
          <h2 className="mt-[100px] md:mt-0 md:ml-[150px] text-center text-2xl py-2 font-semibold md:max-w-none max-w-[350px]">
